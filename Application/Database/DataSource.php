...
require '../php_scripts/send_notif.php';
...
//			self::$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
     ...
     * @return mixed
     */
    public static function updateStatus(string $field, string $status, int $id)
    {
        $result = self::getPDO()->prepare("UPDATE proposal SET $field = '{$status}' WHERE id = '{$id}'");
    //send notifications
        send($id);
