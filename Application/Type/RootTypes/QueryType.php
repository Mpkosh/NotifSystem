...
class QueryType extends ObjectType
{
    public function __construct()
    {
        $config = [
            ...
            'fields' => [
                ...
                'proposal' => [
                    'type' => Types::proposal(), // Тип данных, которые возвращает метод
                    'description' => 'Returns proposal by id (in range of 1-5)', // Описание метода
                    'args' => [ // Аргументы
                        'id' => Types::nonNull(Types::id())
                    ]
                ],
    ...
    /**
     * Поиск единичного заявления из базы данных
     *
     * @param $rootValue
     * @param $args
     * @return mixed
     */
    public function proposal($rootValue, $args, AppContext $context)
    {
        return DataSource::find('Proposal', $args['id']);
    }
}
